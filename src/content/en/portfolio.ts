	...
	projects: [
		{
			...
			caseStudy: {
				...
				role: "Solo builder — product, UI, API Worker, auth, quotas, and Cloudflare deploy.",
				constraints:
				...
				decisions: [
					{
						title: "Separate API Worker for AI",
						detail:
					...
					{
						title: "Prompt engineering over a recipe database",
						detail:
